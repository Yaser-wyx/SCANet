...
from src.bricks.brick_info import Brick, dict_to_cbrick

from src.datasets.legokps_shape_cond_dataset import normalize_euler
from src.datasets.utils import bricks2meshes
...
if __name__ == '__main__':
    ...
    for l in tqdm.tqdm(sorted(os.listdir(args.json_path))):
